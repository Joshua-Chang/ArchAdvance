...
import com.wangyi.arch05_hook.ProxyActivity;
...
//            pluginToAppAction();
    ...
    private void hookAmsAction() throws Exception {
        ...
        Object mIActivityManagerProxy = Proxy.newProxyInstance(
                ...
                HookApplication2.class.getClassLoader(),
    ...
    private ApplicationInfo getApplicationInfoAction() throws Exception {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getAbsoluteFile() + File.separator + "p.apk");
