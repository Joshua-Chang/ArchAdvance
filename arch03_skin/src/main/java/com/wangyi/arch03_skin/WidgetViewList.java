            ...
            for (AttributeNameAndValue attributeNameAndValue : attributeNameAndValues) {
                switch (attributeNameAndValue.attrName) {
                    ...
                    case "tint":
                        ...
                        Log.d("xxx", "tint>>>>>>>>>>>" + attributeNameAndValue.attrValueInt + "  -- " + skinRes.getDefaultSkin());
                        break;
                }
            }
        }
