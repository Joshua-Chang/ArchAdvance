...
public class SkinFactory implements LayoutInflater.Factory2 , Observer {
    ...
    public View onCreateView(@Nullable View parent, @NonNull String name, @NonNull Context context, @NonNull AttributeSet attrs) {
        Log.e("xxx", "onCreateView_1 name:" + name + " attrs:" + attrs.getAttributeName(0));
        ...
        Log.e("xxx", "resultView>>>>>>" + resultView);
    ...
    private View createView(String name, String prefix, Context context, AttributeSet attrs) {
        ...
        if (null == constructors) {
            ...
            Log.d("xxx", "需要反射找的>>>>>>>>>> prefix + name：" + prefix + name);
            // 反射找
            try {
    ...
    public View onCreateView(@NonNull String name, @NonNull Context context, @NonNull AttributeSet attrs) {
        Log.d("xxx", "onCreateView_2 name:" + name);
